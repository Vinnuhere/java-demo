...
public class HttpUtil {
    private static final String appKey = "aa";
    private static final String secretKey = "bb";
    private static final String encry = "HmacSHA256";
    private static final String contentType = "application/json";
    private static final String baseUrl = "https://sapi.floxypay.com";
